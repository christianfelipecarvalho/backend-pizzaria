...
const ListByCategoryConstroller_1 = require("./controllers/product/ListByCategoryConstroller");
...
router.get('/category/product', isAuthenticated_1.isAuthenticated, new ListByCategoryConstroller_1.ListByCategoryController().handle);
...
router.get('/orders', isAuthenticated_1.isAuthenticated, new ListOrdersController_1.ListOrderController().handle);
